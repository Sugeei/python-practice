...
column = 'position_name,position_type,department,location,isfulltime,year_experience,degree,salary,majorwanted,numberofrecuit,attractive,qulification,company_name,industry,company_type,company_level,company_size,company_url,publish_time,original_site_name,position_url'
headers = '''职位名称
            ,职位分类标签
            ,部门
            ,工作地点
